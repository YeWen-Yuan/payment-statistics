...
public class WechatPayAccounting {
    ...
    public AccountingData toAccountingData() {
        ...
        accountingData.setAccountingDate(transactionCreationTime.toString());
        accountingData.setAccountingTime(String.valueOf(paymentTime));
        accountingData.setCategory(type);
        accountingData.setAccountingType(incomeOrExpense);
        accountingData.setAmount(amount);
        accountingData.setOutflowAccount(tradingPartner);
        accountingData.setInflowAccount(productName);
        accountingData.setRemarks(remarks);
